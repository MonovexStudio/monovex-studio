...
export default class RadioBox extends Component {
    ...
    render() {
        ...
        return (
            ...
            <li>
			<input type="radio" defaultChecked={this.props.checked} value={this.props.value} name={this.props.radioGroup} id={"radio-" + this.props.id}/>
            ...
            <circle cx="50%" cy="50%" r="42"  stroke="#005cbf" stroke-width="5" />
                ...
                <circle cx="50%" cy="50%" r="25" stroke="#005cbf" stroke-width="20"  stroke-dasharray="450" stroke-dashoffset="450" />
			</svg>
		    </li>
